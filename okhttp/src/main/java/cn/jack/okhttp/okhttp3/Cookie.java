...
import cn.jack.okhttp.okhttp3.internal.http.HttpDate;
import cn.jack.okhttp.okhttp3.internal.publicsuffix.PublicSuffixDatabase;

import static cn.jack.okhttp.okhttp3.internal.Util.UTC;
import static cn.jack.okhttp.okhttp3.internal.Util.canonicalizeHost;
import static cn.jack.okhttp.okhttp3.internal.Util.delimiterOffset;
import static cn.jack.okhttp.okhttp3.internal.Util.indexOfControlOrNonAscii;
import static cn.jack.okhttp.okhttp3.internal.Util.trimSubstring;
import static cn.jack.okhttp.okhttp3.internal.Util.verifyAsIpAddress;
...
public final class Cookie {
  ...
  public static final class Builder {
    ...
    private Builder domain(String domain, boolean hostOnly) {
      ...
      String canonicalDomain = canonicalizeHost(domain);
      if (canonicalDomain == null) {
