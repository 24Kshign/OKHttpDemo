 ...
 *
 * 路由选择器，负责每次连接进行路由选择操作，路由是干嘛的？
 * 在Address中保存了与目标服务器连接所需的一些地址信息，包括，url主机名，端口，dns等信息，这里我们需要了解一下，一个Address可能对应多个ip地址，
 * 因为一个域名可能对应多个ip，而我们通常是用域名进行网络请求的，所以我们需要找到最终那个ip服务器与之连接，
 * 而路由提供了最终与目标服务器连接所需要的一些信息，比如地址，代理，目标服务器，路由选择器就是用来帮我们选择最终我们需要建立连接的路由即ip/代理
 */
