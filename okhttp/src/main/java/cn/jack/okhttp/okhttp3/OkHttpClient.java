...
import cn.jack.okhttp.okhttp3.internal.connection.RealConnection;
import cn.jack.okhttp.okhttp3.internal.connection.RouteDatabase;
...
import cn.jack.okhttp.okhttp3.internal.tls.CertificateChainCleaner;
...
import static cn.jack.okhttp.okhttp3.internal.Util.assertionError;
import static cn.jack.okhttp.okhttp3.internal.Util.checkDuration;
...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
  ...
  OkHttpClient(Builder builder) {
    ...
    this.eventListenerFactory = builder.eventListenerFactory;  // 事件监听器
    ...
    this.hostnameVerifier = builder.hostnameVerifier;  // 域名验证
    ...
    this.readTimeout = builder.readTimeout;   //读超时时间
    this.writeTimeout = builder.writeTimeout;  //写超时时间
  ...
  public static final class Builder {
     ...
     * calls it is carrying {java.io.IOException will fail with an IOException}.
     *
