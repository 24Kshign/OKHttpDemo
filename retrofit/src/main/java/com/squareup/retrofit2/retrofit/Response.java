...
public final class Response<T> {
  ...
  public static <T> Response<T> success(@Nullable T body) {
    return success(body, new cn.jack.okhttp.okhttp3.Response.Builder() //
        .code(200)
        .message("OK")
   ...
   * body.
   */
  public static <T> Response<T> success(@Nullable T body, cn.jack.okhttp.okhttp3.Response rawResponse) {
  ...
  public static <T> Response<T> error(int code, ResponseBody body) {
    ...
    return error(body, new cn.jack.okhttp.okhttp3.Response.Builder() //
        .code(code)
  ...
  public static <T> Response<T> error(ResponseBody body, cn.jack.okhttp.okhttp3.Response rawResponse) {
  ...
  private final cn.jack.okhttp.okhttp3.Response rawResponse;
  private final @Nullable T body;
  private final @Nullable ResponseBody errorBody;

  private Response(cn.jack.okhttp.okhttp3.Response rawResponse, @Nullable T body,
  ...
  public cn.jack.okhttp.okhttp3.Response raw() {
    return rawResponse;
  }
